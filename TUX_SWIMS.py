...
himmelImg = pygame.image.load('himmel4.jpg')
bedrockImg = pygame.image.load('bedrock3.jpg')
wolkeImg = pygame.image.load('vogel.png')
...
def himmel(hx,hy,h_speed):
    gameDisplay.blit(himmelImg,(hx,hy))
def bedrock(bex,bey,be_speed):
    gameDisplay.blit(bedrockImg,(bex,bey))
def wolke(wox,woy,wo_speed):
    gameDisplay.blit(wolkeImg,(wox,woy))
...
def eaten_fish(text):
    ...
    if finish == 1:
        largeText = pygame.font.Font('freesansbold.ttf',40)
        TextSurf, TextRect = text_objects(text, largeText)
        TextRect.center = ((display_width - 220),(display_height - 50))
        gameDisplay.blit(TextSurf, TextRect)
        pygame.display.update()
def musik():
    if finish == 1:
...
#Hintergrund:
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx, k_starty), 120)
        k_startx += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx2, k_starty), 120)
        k_startx2 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx3, k_starty), 120)
        k_startx3 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx4, k_starty), 120)
        k_startx4 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx5, k_starty), 120)
        k_startx5 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx6, k_starty), 120)
        k_startx6 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx7, k_starty), 120)
        k_startx7 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx8, k_starty), 120)
        k_startx8 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx9, k_starty), 120)
        k_startx9 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx10, k_starty), 120)
        k_startx10 += k_speed
        ...
        pygame.draw.circle(gameDisplay, yellow, (k_startx11, k_starty), 120)
        k_startx11 += k_speed
        ...
        #himmel
        himmel(hx, hy, h_speed)

        bedrock(bex, bey, be_speed)
        bex += be_speed
        if bex < -90:
            bex = 1920

        wolke(wox, woy, wo_speed)
        wox += wo_speed
        if wox < -40:
            wox = 1920

        wolke(wox2, woy2, wo_speed)
        wox2 += wo_speed
        if wox2 < -40:
            wox2 = 1920
